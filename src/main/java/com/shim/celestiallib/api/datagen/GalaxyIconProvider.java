...
public class GalaxyIconProvider implements DataProvider {
    ...
    public GalaxyIconProvider(DataGenerator generatorIn, String modid, ExistingFileHelper fileHelperIn) {
