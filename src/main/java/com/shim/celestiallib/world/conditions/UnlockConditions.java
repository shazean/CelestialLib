...
public class UnlockConditions {
    ...
    public static final DeferredRegister<IUnlockCondition> CONDITION_REGISTRY = DeferredRegister.create(new ResourceLocation(CelestialLib.MODID, "planet_registry"), CelestialLib.MODID);
